...
<head>
    ...
    <script>
        (function() {
            ...
            t && r.append("utm_source", t), n && r.append("x-breakdown-id", n);
            const c = r.toString(),
                s = `https://crm.atalaya.pe/free/pixel/5485e4be-54e0-11ef-bfda-26a0a2e74226${c?"?"+c:""}`,
                a = document.createElement("script");
            a.type = "text/javascript", a.async = !0, a.src = s;
