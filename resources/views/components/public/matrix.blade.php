...
<body id="inicio">
    ...
    <script>
        ...
        //     if (!validarTelefono($('#contact_phone').val())) {
        //         return;
        //     };

        //     if (!validarEmail($('#contact_email').val())) {
        //         return;
        //     };
